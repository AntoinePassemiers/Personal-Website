...
title: Pourquoi vous devez vous méfier de la cross-validation par leave-one-out
...
`scikit-learn` passe ces pondérations à `libsvm`, qui les utilise pour définir les bornes supérieures sur les paramètres de Lagrange: `class_weight[i] * C`
